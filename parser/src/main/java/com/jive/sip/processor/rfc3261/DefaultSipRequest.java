...
public final class DefaultSipRequest extends DefaultSipMessage implements SipRequest
{
  ...
  public DefaultSipRequest(final RfcSipMessageManager manager,
  ...
  public SipMessage withHeader(final RawHeader header)
  {
    ...
    headers.add(header);
    final DefaultSipMessage result = new DefaultSipRequest(this.manager.adapt(RfcSipMessageManager.class),
        this.method, this.uri, this.version, headers, this.body);
    return result;
  }
  ...
  public SipMessage withReplacedHeaders(final RawHeader... headers)
  {
    ...
    final DefaultSipMessage result = new DefaultSipRequest(this.manager.adapt(RfcSipMessageManager.class),
        this.method, this.uri, this.version, headerList, this.body);
    return result;
  }
  ...
  {
    final DefaultSipRequest result = new DefaultSipRequest(this.manager.adapt(RfcSipMessageManager.class),
        this.method, uri, this.version, this.headers, this.body);
    return result;
  }
  ...
  {
    final DefaultSipRequest result = new DefaultSipRequest(this.manager.adapt(RfcSipMessageManager.class),
        method, this.uri, this.version, this.headers, this.body);
    return result;
  }
  ...
  {
    final DefaultSipRequest result = new DefaultSipRequest(this.manager.adapt(RfcSipMessageManager.class),
        this.method, this.uri, this.version, this.headers, body);
  ...
  public DefaultSipRequest withoutHeaders(final String... headerNames)
  {
    ...
    final DefaultSipRequest result = new DefaultSipRequest(this.manager.adapt(RfcSipMessageManager.class), this.method, this.uri, this.version, keepers,
        this.body);
    return result;
  }
  ...
  public SipRequest withPrepended(final String header, final Object value)
  {
    ...
    final DefaultSipRequest result = new DefaultSipRequest(this.manager.adapt(RfcSipMessageManager.class), this.method, this.uri, this.version, headers,
        this.body);
    return result;
  }
