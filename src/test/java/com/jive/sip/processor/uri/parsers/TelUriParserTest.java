...
public class TelUriParserTest extends BaseParserTest<TelUri>
{
  ...
  {
    assertEquals(
        new TelUri("863-1234", DefaultParameters.from(Lists.newArrayList(new RawParameter(
            "phone-context", new TokenParameterValue("+1-914-555"))))),
