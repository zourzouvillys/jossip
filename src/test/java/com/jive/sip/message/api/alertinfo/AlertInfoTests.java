...
public class AlertInfoTests
{
  ...
  public void testUrnAlertInfo() throws Exception
  {
    ...
    assertEquals(new WellKnownAlertInfo(new UrnUri("alert", new UrnService("service:call-waiting:abc@example"))), header.getUri().apply(AlertInfoUriExtractor.getInstance()));
  }
