...
public class NameAddrParserTest extends BaseParserTest<NameAddr>
{
  ...
  List<RawParameter> simpleParams = Lists.newArrayList(new RawParameter(Token.from("tag"), new TokenParameterValue(
      "xxxx")));
  ...
  public void testStaticParsing()
  {
    ...
    assertEquals("+18009453669", value.getAddress().apply(TelUriExtractor.getInstance())
        .getNumber());
