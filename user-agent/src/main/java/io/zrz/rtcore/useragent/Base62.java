...
/**
 * Utility class to encode/decode bytes into Base62 strings in the same form as <a href=
 * "https://github.com/segmentio/ksuid/blob/master/base62.go">https://github.com/segmentio/ksuid/blob/master/base62.go</a>
 * <p>
...
public final class Base62 {
  ...
  public static String base62Encode(final byte[] bytes) {
   ...
   * Encode bytes to Base62 string.
   * <p>
   * If length is greater than the size of the Base62 string, the returned string will be padded
   * with zeros up to length size.
   * <p>
   * See
   * <a href="https://stackoverflow.com/questions/14110010/base-n-encoding-of-a-byte-array">stack
   * overflow comments</a> for the inspiration of this method.
   *
   * @param bytes
   *          bytes to encode
   * @param length
   *          length to which to pad the returned string with zeros
   * @return a Base62 string
   */

  public static String base62Encode(final byte[] bytes, final int length) {
