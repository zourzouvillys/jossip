...
public class FixtureWhenBuilder {

  private SignalState currentState;

  FixtureWhenBuilder(SignalState currentState) {
  ...
  public FixtureResponseBuilder response(UaRole initiator, long sequence, SipMethod method, int status) {
